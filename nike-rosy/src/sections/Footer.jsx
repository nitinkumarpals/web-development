    ...
    <footer className='max-container'>
      <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          ...
          <p className='text-base mt-6 leading-7 font-montserrat text-white-400 sm:max-w-sm'>Get shoes ready for the new term at your nearest Nike store. Find Your perfect Size In Store. Get Rewards
          </p>
               ...
               <div key={index}>
                ...
                <ul>
                  {section.links.map((link, index) => (
                    <li key={index} className='text-white-400 mt-3 font-montserrat text-base leading-normal hover:text-slate-gray cursor-pointer'>
                      <a>{link.name}</a>
                    </li>
                  ))}
                </ul>
